...
public:
    ...
    void InorderTraversal(Node *key)
    {
        ...
        {
            InorderTraversal(key->Lchild);
            cout << key->data << " ";
            InorderTraversal(key->Rchild);
        }
    }

    // PreOrder Traversal;
    void preorderTraversal(Node *key)
    {
        if (key == NULL)
        {
        ...
        {
            preorderTraversal(key->Lchild);
            cout << key->data << " ";
            preorderTraversal(key->Rchild);
        }
    }
};
int main()
{
    ...
    // Inorder traversal;
    cout << "INORDER TRAVERSAL ALGORITHM : " << endl;
    tree.InorderTraversal(tree.root);
    cout << endl;
    // preorder traversal;
    cout << "preorder TRAVERSAL ALGORITHM : " << endl;
